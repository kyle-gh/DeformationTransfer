Small collection of reference meshes used for testing the implementation.
horse-## and camel-## have corresponding poses.
horse-reference and camel-reference are unposed.

Data is provided by Bob Sumner, et al. as part of their publication.
