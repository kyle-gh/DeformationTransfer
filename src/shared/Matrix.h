...
void QRDecompose(const Eigen::Matrix<double, n_rows, n_cols>& m, Eigen::Matrix<double, n_rows, n_cols>& q, Eigen::Matrix<double, n_cols, n_cols>& r)
{
...
inline std::string Error(Eigen::ComputationInfo info)
{
    switch(info)
    {
        ...
        case Eigen::NumericalIssue: return "Numerical Issue";
        
        /** Iterative procedure did not converge. */
        case Eigen::NoConvergence: return "No Convergence";
            
        /** The inputs are invalid, or the algorithm has been improperly called.
         * When assertions are enabled, such errors trigger an assert. */
        case Eigen::InvalidInput: return "Invalid Input";
    }
